...
import type { AdminJsonResource, AdminJsonSite } from "@/admin/json/site";
...
export interface AdminJsonRouterOptions {
...
function requireResource(site: AdminJsonSite, name: string): AdminJsonResource {
 ...
 */
export function makeAdminJsonRouter(
  site: AdminJsonSite,
  options: AdminJsonRouterOptions = {},
): Router {
